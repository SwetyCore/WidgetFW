...
namespace DefaultStyle.Convertor
{
    ...
    internal class ClassTime : IValueConverter
    {
        public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
        {
            ...
            var st = from section in Widgets.AISchedule.sections where section.i == first select section.s; ;
            var et = from section in Widgets.AISchedule.sections where section.i == last select section.e;
